...
method Kernel::Multicore::Run(UInt32 core_id) -> Void {
    ...
    case 1:
		while (true) {
			...
			var context = DrawContext(20, 20, 100, 100);
			context.align = DrawContext::Alignment::justify;
			context.font = Font::HelveticaItalic(Font::Size::xSmall);
			context.drawText(default_text);

			context = DrawContext(130, 20, 150, 100);
			context.align = DrawContext::Alignment::justify;
			context.font = Font::HelveticaItalic(Font::Size::small);
			context.drawText(default_text);

			context = DrawContext(290, 20, 150, 100);
			context.align = DrawContext::Alignment::justify;
			context.font = Font::HelveticaItalic(Font::Size::medium);
			context.drawText(default_text);

			context = DrawContext(450, 20, 200, 100);
			context.align = DrawContext::Alignment::justify;
			context.font = Font::HelveticaItalic(Font::Size::large);
			context.drawText(default_text);

			context = DrawContext(660, 20, 200, 200);
			context.align = DrawContext::Alignment::justify;
			context.font = Font::HelveticaItalic(Font::Size::xLarge);
			context.drawText(default_text);

			context = DrawContext(20, 100, 300, 200);
			context.align = DrawContext::Alignment::justify;
			context.font = Font::HelveticaItalic(Font::Size::xxLarge);
			context.drawText(default_text);
			
			context = DrawContext(50, 300, 100, 100);
			context.drawPixmap(&examplePixmap, Point(0, 0));
			context.drawPixmap(&examplePixmap, Rect(4, 4, 8, 8), Point(25, 4));

			context = DrawContext(5, 520, 300, 20);
			context.align = DrawContext::Alignment::justify;
			context.font = Font::Helvetica(Font::Size::medium);
			context.drawText(VersionString());
