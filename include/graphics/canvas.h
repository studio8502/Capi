...
public:
    ...
    /// while negative x values shift left, positive y values shift up, and
    ...
    /// Tip: use this to get the rendered image from the canvas after drawing.
    ///
    /// @param image   pointer to unpremultiplied sRGB BGRA8 image data
    /// @param width   width of the image in pixels
    /// @param height  height of the image in pixels
    /// @param stride  number of bytes between the start of each image row
    /// @param x       horizontal coordinate of upper-left pixel to fetch
    /// @param y       vertical coordinate of upper-left pixel to fetch
    void get_image_data_bgra(
        unsigned char *image,
        int width,
        int height,
        int stride,
...
void canvas::get_image_data_bgra(
    unsigned char *image,
    int width,
    int height,
    int stride,
